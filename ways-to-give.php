...
<head>
	...
	<title>Onslow Memorial Hospital Foundation | Ways to Give</title>
...
<div id="wrapper"> 
    ...
    <div id="content">
        ...
        <!-- END SIDEBAR PHP -->  
         <div id="mainContent">
         <img src="images/header-waystogive.jpg" />
         <p>&nbsp;</p>
         <h2><a href="sponsor.php">Sponsor an Event</a></h2>
         <h2>           <a href="donate.php">Online Giving</a></h2>
         <h2>           <a href="planned-giving.php">Planned Giving</a></h2>
         <h2><a href="volunteer.php">Volunteer Opportunities</a></h2>
      </div> <!--end #mainContent -->
         <div class="clear">&nbsp;</div>
     </div> <!--End #content -->

...
<head>
	...
	<title>Onslow Memorial Hospital Foundation | Press Release</title>
...
<div id="wrapper"> 
    ...
    <div id="content">
        ...
        <!-- END SIDEBAR PHP -->  
         <div id="mainContent">
         <img src="http://placehold.it/700x196" />
         <h2>Press Release</h2>
<p>Main content text area. Use a new paragraph tag for each new paragraph.</p>

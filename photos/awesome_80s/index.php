...
*/
$dir_nav['enable']     = FALSE;    // Enable Directory Navigation.  If disabled,
...
$ctrl_bar['vw_ctrl']  = FALSE;   // Enable control bar Links Style chooser.
$ctrl_bar['sz_ctrl']  = FALSE;  // Enable control bar Default Size chooser.
$ctrl_bar['small']    = FALSE;   // Use small text for control bar.
...
$caption['padding']   = '13px';  // Padding around caption text
...
$lwr_nav['frst_last'] = FALSE;   // Show ` |<< ' and ` >>| ' links.
...
$lwr_nav['width']     = 'auto';  // Width of this navRow's table
$lwr_nav['pad_top']   = '15px';  // Padding above row
...
$qdig_homelink['ena']  = FALSE;      // Show the Qdig Home link.
...
$header['css_bgcolor']     = '#ffffff';  // Page Background

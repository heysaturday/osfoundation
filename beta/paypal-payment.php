...
<div id="wrapper"> 
    ...
    <div id="content">
        ...
        <div class="sidebarHeader">
          <a href="sponsor.php"><img src="images/2013-event.png" /></a>        </div>
        <div class="sidebarHeader">
        <a href="newsletter.php"><img src="images/newsletter-cover.png" /></a>
        
        <img src="images/divider.png" />
        <a href="newsletter.php"><img src="images/btn-donate-now.png" /></a><br />
        <br />
        </div>
        
      </div> 
         <div id="mainContent">
         <img src="images/header-generic.jpg" />
         <h2>Thank you for your generous contribution.</h2>
<p>To return to the OMH Foundation home page, click <a href="index.php">here</a>.</p>
<div id="contact">
</div>

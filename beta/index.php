...
<div id="wrapper"> 
    ...
    <div id="content">
        ...
        <img src="images/HomeLogo.png" border="0" usemap="#Map" />
<map name="Map" id="Map"><area shape="rect" coords="5,14,254,167" href="upcoming-events.php" target="_parent" />
</map>
        <img src="images/divider.png" />        </div>
        <div class="sidebarHeader">
        <img src="images/latest-header.gif" style="margin-bottom:21px;" />

        <h3><a href="news.php">Plans on the horizon for <br />
          next big event</a></h3>
        <p class="date">11/22/2011</p>
        
        
        <h3><a href="news.php">Estate Planning Seminar <br />
          November 3rd, 2011</a></h3>
        <p class="date">09/30/2011</p>
        
        
        <p class="readMore"><a href="news.php">Read more news posts &raquo;</a></p>
        <img src="images/divider.png" />
        <a href="donate.php"><img src="images/btn-donate-now.png" /></a>        </div>
